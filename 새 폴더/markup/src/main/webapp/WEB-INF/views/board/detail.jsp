...
<link href="/resources/css/board/boardDetail2.css" rel="stylesheet" />
	...
	<div class="container">
		<div class="bigtitleBox">
		    ...
		    <a href="/member/mypage?id=${board.id}">
		        <img src="/upload/profile/${writer.imgFile}" style="width: 30px; height: 30px; border-radius: 50%;">
		        <span style="margin-left: 10px; font-weight: 600;">${writer.name}</span>
		    </a>
		    </div>
		    <div class="mintitlebox"> no.${board.bno}&nbsp;&nbsp;|&nbsp;&nbsp;${board.regDate}</div>
		    <hr>
		</div>
		<c:choose>
		...
		<div id="boardBox" class="boardBox${classname}">
		    <div class="textcontent">${board.bcontent}</div>
		    <div class="tagdiv">
...
<%-- 		    <div class="likebox">
		...
		<div id=commentBox class="commentbbox${classname}">
		        <!-- <div class="toggle" id="toggleComment"> -->
		        <div class="toggle" id="toggleComment">
		            <h2 class="h2co" style="text-align: left; margin-left: 10px" id="tH1">댓글 ▷</h2>
		        </div>
		        ...
		        <div class="commentContainer" id="commentContainer">
		            ...
		            <div class="commentBox" id="commentBox">
		                ...
		                <div class="form-floating cmtbox">
		                    <%-- <span id="cmtWriter">${ses.name}</span> --%>
      ...
      <c:choose>
         <c:when test="${ses.id eq board.id }">
            ...
            <button type="button" id="listBlackBtn" data-bno="${board.bno }" class=" btn btn-outline-secondary" style="display: none;">신고</button>
         </c:when>
         <c:otherwise>
            <button type="button" id="listBlackBtn" data-bno="${board.bno }" class=" btn btn-outline-secondary">신고</button>
         </c:otherwise>
      </c:choose>
         </div>
